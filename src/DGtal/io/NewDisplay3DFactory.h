...
/**
 * @file NewDisplay3DFactory.h
 * @author Martial Tola <http://liris.cnrs.fr/martial.tola/>
 * @date mercredi 21 septembre 2011
 *
 * @brief
 *
 * Header file for module NewDisplay3DFactory
 *
 * This file is part of the DGtal library.
 */

#if defined(NewDisplay3DFactory_RECURSES)
#error Recursive header files inclusion detected in NewDisplay3DFactory.h
#else // defined(NewDisplay3DFactory_RECURSES)
/** Prevents recursive inclusion of headers. */
#define NewDisplay3DFactory_RECURSES

#if !defined NewDisplay3DFactory_h
/** Prevents repeated inclusion of headers. */
#define NewDisplay3DFactory_h
...
{
  /////////////////////////////////////////////////////////////////////////////
  // struct NewDisplay3DFactory
  /**
   * Description of struct 'NewDisplay3DFactory' <p>
   * \brief Factory for GPL NewDisplay3D:
   */
  ...
  struct NewDisplay3DFactory
  {
    ...
    typedef NewDisplay3DFactory<Space, KSpace> Self;
    typedef NewDisplay3D<Space, KSpace> Display;
    ...
    static
    void
    draw(NewDisplay3D<Space, KSpace>& display, const DGtal::DiscreteExteriorCalculus<dimEmbedded, dimAmbient, TLinearAlgebraBackend, TInteger>& calculus);
    // DiscreteExteriorCalculus
    ...
    static
    void
    draw(NewDisplay3D<Space, KSpace>& display, const DGtal::KForm<Calculus, order, duality>& kform, double cmap_min = 0, double cmap_max = 0);

    template <typename Calculus, DGtal::Order order, DGtal::Duality duality, typename ColorMap>
    static
    void
    drawWithColorMap(NewDisplay3D<Space, KSpace>& display, const DGtal::KForm<Calculus, order, duality>& kform, const ColorMap& colormap);
    // KForm
    ...
    static
    void
    draw(NewDisplay3D<Space, KSpace>& display, const DGtal::VectorField<Calculus, duality>& vector_field, const double& scale = 0.5, const double& epsilon = 1e-5, const DGtal::Color color = DGtal::Color::Black);
    // VectorField
     ...
     * sublists for NewDisplay3D models.
     * @param display the display where to draw
     * @param anObject the object to draw
     */
    static void
...
template<typename TImage, typename TFunctor>
    ...
    static void draw( NewDisplay3D<Space,KSpace> & viewer, const ImageContainerBySTLVector<DGtal::Z2i::Domain, TValue> & anImage );
    // ImageContainerBySTLVector (2D)
    ...
    static void draw( NewDisplay3D<Space,KSpace> & viewer, const ConstImageAdapter<TImageContainer, DGtal::Z2i::Domain, TFunctorD, TNewValue, TFunctorValue> & anImage );
    // ConstImageAdapter (2D)
     ...
     */
    template <typename TValue>
    static void draw( NewDisplay3D<Space,KSpace> & viewer, const ImageContainerBySTLVector<DGtal::Z3i::Domain, TValue> & anImage );
    // ImageContainerBySTLVector (3D)
     ...
     */
    template <typename TImageContainer, typename TFunctorD, typename TNewValue, typename TFunctorValue>
    static void draw( NewDisplay3D<Space,KSpace> & viewer, const ConstImageAdapter<TImageContainer, DGtal::Z3i::Domain, TFunctorD,
                      TNewValue, TFunctorValue> & anImage );
    // ConstImageAdapter (3D)
   
}; // end of struct NewDisplay3DFactory
...
#include "DGtal/io/NewDisplay3DFactory.ih"

// //
///////////////////////////////////////////////////////////////////////////////

#endif // !defined NewDisplay3DFactory_h

#undef NewDisplay3DFactory_RECURSES
#endif // else defined(NewDisplay3DFactory_RECURSES)
